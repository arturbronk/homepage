...
const Myclick = () => {                             //funkcja nazwana MyClick, która zadzieje się po kliknięciu
...
button.addEventListener('click', () => {          //ta sama funkcja i akcja co powyżej ale zapisana w postaci strzałkowej
...
myHeading.classList.add('klasa-z-js');    
});
